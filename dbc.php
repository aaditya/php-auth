<?php
/*************** PHP LOGIN SCRIPT V 2.4*********************
(c) Balakrishnan 2009-2015. All Rights Reserved
Modded by Aaditya Chakravarty , 2015
...
session_start();
if(!empty($_SESSION['user_name'])){header("Location: /myaccount.php");}
}
